 ...
 * @property integer $allow_edit_roles
 ...
 * @property RoleTypeLog[] $roleTypeLogs
 */
class RoleType extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRoleTypeLogs()
    {
        return $this->hasMany(RoleTypeLog::className(), ['role_type_id' => 'id']);
    }
}
