...
/**
 * RoleTypeSearch represents the model behind the search form about `\app\models\RoleType`.
 */
class RoleTypeSearch extends RoleType
{
    ...
    {
        return [
            [['id', 'allow_edit_project', 'allow_edit_partners', 'allow_edit_products', 'allow_edit_events', 'allow_edit_participants', 'allow_edit_roles', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'allow_edit_roles' => $this->allow_edit_roles,
